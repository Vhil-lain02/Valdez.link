...
<div class="form-group">
      ...
      <div class="form-group">
        ...
        <textarea type="text" class="form-control"  placeholder="Enter Descripttion" name="txtdescription" rows="4" required><?php echo $description_db;?></textarea>
      </div>
...
<div class="form-group">
      ...
      <div class="form-group">
        ...
        <image src="productimage/<?php echo $image_db;?>" class="img-rounded" width="50px" height="50px/">
