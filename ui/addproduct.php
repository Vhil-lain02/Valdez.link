...
if($f_extension=='jpg' || $f_extension=='jpeg' || $f_extension=='png' || $f_extension=='webp' || $f_extension=='gif'){
...
$_SESSION['status'] = "only jpg, jpeg, png, webp, and gif can be upload";
$_SESSION['status_code'] = "warning";
...
<div class="form-group">
      ...
      <div class="form-group">
        ...
        <textarea type="text" class="form-control"  placeholder="Enter Descripttion" name="txtdescription" rows="4" required></textarea>
      </div>
...
<div class="form-group">
      ...
      <div class="form-group">
        ...
        <p>Upload image</p>
              ...
              <button type="submit" class="btn btn-success" name="btnsave">Save Product</button></div>
              </div>
              </form>
